...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ErrorResponseAutoGenerated
    {
        ...
        {
            Details = new ChangeTrackingList<ErrorResponseAutoGenerated>();
        ...
        internal ErrorResponseAutoGenerated(string code, string message, string target, IReadOnlyList<ErrorResponseAutoGenerated> details, IReadOnlyList<ErrorAdditionalInfo> additionalInfo)
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IReadOnlyList<ErrorResponseAutoGenerated> Details { get; }
