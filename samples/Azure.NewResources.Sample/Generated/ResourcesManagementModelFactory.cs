...
using Azure.ResourceManager.NewResources.Models;
...
namespace Azure.ResourceManager.NewResources
{
    ...
    public static partial class ResourcesManagementModelFactory
    {
        ...
        public static PolicyAssignment PolicyAssignment(string id = default, string type = default, string name = default, PolicySku sku = default, string location = default, Identity identity = default, string displayName = default, string policyDefinitionId = default, string scope = default, IList<string> notScopes = default, IDictionary<string, ParameterValuesValue> parameters = default, string description = default, object metadata = default, EnforcementMode? enforcementMode = default)
        {
        ...
        public static DeploymentScript DeploymentScript(string id = default, string name = default, string type = default, ManagedServiceIdentity identity = default, string location = default, IDictionary<string, string> tags = default, ScriptType kind = default, SystemData systemData = default)
        {
            tags ??= new Dictionary<string, string>();
        ...
        public static ScriptLog ScriptLog(string id = default, string name = default, string type = default, string log = default)
        {
        ...
        public static Application Application(string id = default, string name = default, string type = default, string location = default, IDictionary<string, string> tags = default, string managedBy = default, Sku sku = default, IdentityAutoGenerated identity = default, Plan plan = default, string kind = default, string managedResourceGroupId = default, string applicationDefinitionId = default, object parameters = default, object outputs = default, ProvisioningState? provisioningState = default)
        {
            tags ??= new Dictionary<string, string>();
        ...
        public static ApplicationPatchable ApplicationPatchable(string id = default, string name = default, string type = default, string location = default, IDictionary<string, string> tags = default, string managedBy = default, Sku sku = default, IdentityAutoGenerated identity = default, PlanPatchable plan = default, string kind = default, string managedResourceGroupId = default, string applicationDefinitionId = default, object parameters = default, object outputs = default, ProvisioningState? provisioningState = default)
        {
            tags ??= new Dictionary<string, string>();
        ...
        public static AzureCliScript AzureCliScript(string id = default, string name = default, string type = default, ManagedServiceIdentity identity = default, string location = default, IDictionary<string, string> tags = default, ScriptType kind = default, SystemData systemData = default, ContainerConfiguration containerSettings = default, StorageAccountConfiguration storageAccountSettings = default, CleanupOptions? cleanupPreference = default, ScriptProvisioningState? provisioningState = default, ScriptStatus status = default, IReadOnlyDictionary<string, object> outputs = default, string primaryScriptUri = default, IList<string> supportingScriptUris = default, string scriptContent = default, string arguments = default, IList<EnvironmentVariable> environmentVariables = default, string forceUpdateTag = default, TimeSpan retentionInterval = default, TimeSpan? timeout = default, string azCliVersion = default)
        {
            tags ??= new Dictionary<string, string>();
            outputs ??= new Dictionary<string, object>();
            supportingScriptUris ??= new List<string>();
