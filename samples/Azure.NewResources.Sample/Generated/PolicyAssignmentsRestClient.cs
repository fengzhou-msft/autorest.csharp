...
namespace Azure.ResourceManager.NewResources
{
    internal partial class PolicyAssignmentsRestClient
    {
        ...
        public PolicyAssignmentsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
        ...
        internal Azure.Core.HttpMessage CreateCreateRequest(string scope, string policyAssignmentName, PolicyAssignment parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateCreateByIdRequest(string policyAssignmentId, PolicyAssignment parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
