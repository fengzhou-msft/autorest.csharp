...
namespace Azure.ResourceManager.NewResources
{
    internal partial class PolicySetDefinitionsRestClient
    {
        ...
        public PolicySetDefinitionsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateRequest(string policySetDefinitionName, PolicySetDefinition parameters)
        {
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateAtManagementGroupRequest(string policySetDefinitionName, string managementGroupId, PolicySetDefinition parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
