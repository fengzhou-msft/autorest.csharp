...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ResourcesCreateOrUpdateOperation : Operation<GenericResource>, IOperationSource<GenericResource>
    {
        ...
        internal ResourcesCreateOrUpdateOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<GenericResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ResourcesCreateOrUpdateOperation");
