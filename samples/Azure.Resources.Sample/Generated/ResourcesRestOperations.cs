...
namespace Azure.ResourceManager.Resources
{
    internal partial class ResourcesRestOperations
    {
        ...
        internal Azure.Core.HttpMessage CreateMoveResourcesRequest(string sourceResourceGroupName, IEnumerable<string> resources, string targetResourceGroup)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            if (resources != null)
            {
                ...
                {
                    resourcesMoveInfo.Resources.Add(value);
                }
            }
            var model = resourcesMoveInfo;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="sourceResourceGroupName"/> is null. </exception>
        public async Task<Response> MoveResourcesAsync(string sourceResourceGroupName, IEnumerable<string> resources = null, string targetResourceGroup = null, CancellationToken cancellationToken = default)
        {
        ...
        internal Azure.Core.HttpMessage CreateValidateMoveResourcesRequest(string sourceResourceGroupName, IEnumerable<string> resources, string targetResourceGroup)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="sourceResourceGroupName"/> is null. </exception>
        public async Task<Response> ValidateMoveResourcesAsync(string sourceResourceGroupName, IEnumerable<string> resources = null, string targetResourceGroup = null, CancellationToken cancellationToken = default)
        {
            if (sourceResourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(sourceResourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateCheckExistenceRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string apiVersion)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateDeleteRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string apiVersion)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string apiVersion, GenericResourceData parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateUpdateRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string apiVersion, GenericResourceData parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateGetRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string apiVersion)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateCheckExistenceByIdRequest(string resourceId, string apiVersion)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Head;
        ...
        internal Azure.Core.HttpMessage CreateDeleteByIdRequest(string resourceId, string apiVersion)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateByIdRequest(string resourceId, string apiVersion, GenericResourceData parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        internal Azure.Core.HttpMessage CreateUpdateByIdRequest(string resourceId, string apiVersion, GenericResourceData parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Patch;
        ...
        internal Azure.Core.HttpMessage CreateGetByIdRequest(string resourceId, string apiVersion)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
