...
namespace Azure.ResourceManager.Resources
{
    internal partial class DeploymentsRestOperations
    {
        ...
        internal Azure.Core.HttpMessage CreateDeleteAtSubscriptionScopeRequest(string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        public async Task<Response> DeleteAtSubscriptionScopeAsync(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
            ...
            using var message = CreateDeleteAtSubscriptionScopeRequest(deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 202:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public Response DeleteAtSubscriptionScope(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        internal Azure.Core.HttpMessage CreateCheckExistenceAtSubscriptionScopeRequest(string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Head;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public async Task<Response> CheckExistenceAtSubscriptionScopeAsync(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
            ...
            using var message = CreateCheckExistenceAtSubscriptionScopeRequest(deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public Response CheckExistenceAtSubscriptionScope(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateAtSubscriptionScopeRequest(string deploymentName, string subscriptionId, Deployment parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="parameters"> Additional parameters supplied to the operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="parameters"/> is null. </exception>
        public async Task<Response> CreateOrUpdateAtSubscriptionScopeAsync(string deploymentName, string subscriptionId, Deployment parameters, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
            ...
            using var message = CreateCreateOrUpdateAtSubscriptionScopeRequest(deploymentName, subscriptionId, parameters);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="parameters"/> is null. </exception>
        public Response CreateOrUpdateAtSubscriptionScope(string deploymentName, string subscriptionId, Deployment parameters, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        internal Azure.Core.HttpMessage CreateGetAtSubscriptionScopeRequest(string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public async Task<Response<DeploymentExtendedData>> GetAtSubscriptionScopeAsync(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
            ...
            using var message = CreateGetAtSubscriptionScopeRequest(deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public Response<DeploymentExtendedData> GetAtSubscriptionScope(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        internal Azure.Core.HttpMessage CreateCancelAtSubscriptionScopeRequest(string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public async Task<Response> CancelAtSubscriptionScopeAsync(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
            ...
            using var message = CreateCancelAtSubscriptionScopeRequest(deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public Response CancelAtSubscriptionScope(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        internal Azure.Core.HttpMessage CreateValidateAtSubscriptionScopeRequest(string deploymentName, string subscriptionId, Deployment parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="parameters"/> is null. </exception>
        public async Task<Response> ValidateAtSubscriptionScopeAsync(string deploymentName, string subscriptionId, Deployment parameters, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
            ...
            using var message = CreateValidateAtSubscriptionScopeRequest(deploymentName, subscriptionId, parameters);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="parameters"/> is null. </exception>
        public Response ValidateAtSubscriptionScope(string deploymentName, string subscriptionId, Deployment parameters, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        internal Azure.Core.HttpMessage CreateWhatIfAtSubscriptionScopeRequest(string deploymentName, string subscriptionId, DeploymentWhatIfProperties properties, string location)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="location"> The location to store the deployment data. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="properties"/> is null. </exception>
        public async Task<Response> WhatIfAtSubscriptionScopeAsync(string deploymentName, string subscriptionId, DeploymentWhatIfProperties properties, string location = null, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
            ...
            using var message = CreateWhatIfAtSubscriptionScopeRequest(deploymentName, subscriptionId, properties, location);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="properties"/> is null. </exception>
        public Response WhatIfAtSubscriptionScope(string deploymentName, string subscriptionId, DeploymentWhatIfProperties properties, string location = null, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        internal Azure.Core.HttpMessage CreateExportTemplateAtSubscriptionScopeRequest(string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public async Task<Response<DeploymentExportResult>> ExportTemplateAtSubscriptionScopeAsync(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
            ...
            using var message = CreateExportTemplateAtSubscriptionScopeRequest(deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public Response<DeploymentExportResult> ExportTemplateAtSubscriptionScope(string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        internal Azure.Core.HttpMessage CreateListAtSubscriptionScopeRequest(string subscriptionId, string filter, int? top)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<DeploymentListResult>> ListAtSubscriptionScopeAsync(string subscriptionId, string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
            ...
            using var message = CreateListAtSubscriptionScopeRequest(subscriptionId, filter, top);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> is null. </exception>
        public Response<DeploymentListResult> ListAtSubscriptionScope(string subscriptionId, string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        internal Azure.Core.HttpMessage CreateDeleteRequest(string resourceGroupName, string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        public async Task<Response> DeleteAsync(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateDeleteRequest(resourceGroupName, deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 202:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public Response Delete(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateCheckExistenceRequest(string resourceGroupName, string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Head;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public async Task<Response> CheckExistenceAsync(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateCheckExistenceRequest(resourceGroupName, deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public Response CheckExistence(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateRequest(string resourceGroupName, string deploymentName, string subscriptionId, Deployment parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="parameters"> Additional parameters supplied to the operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="parameters"/> is null. </exception>
        public async Task<Response> CreateOrUpdateAsync(string resourceGroupName, string deploymentName, string subscriptionId, Deployment parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateCreateOrUpdateRequest(resourceGroupName, deploymentName, subscriptionId, parameters);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="parameters"/> is null. </exception>
        public Response CreateOrUpdate(string resourceGroupName, string deploymentName, string subscriptionId, Deployment parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateGetAtResourceGroupScopeRequest(string resourceGroupName, string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public async Task<Response<DeploymentExtendedData>> GetAtResourceGroupScopeAsync(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateGetAtResourceGroupScopeRequest(resourceGroupName, deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public Response<DeploymentExtendedData> GetAtResourceGroupScope(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateCancelRequest(string resourceGroupName, string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public async Task<Response> CancelAsync(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateCancelRequest(resourceGroupName, deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public Response Cancel(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateValidateRequest(string resourceGroupName, string deploymentName, string subscriptionId, Deployment parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="parameters"/> is null. </exception>
        public async Task<Response> ValidateAsync(string resourceGroupName, string deploymentName, string subscriptionId, Deployment parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateValidateRequest(resourceGroupName, deploymentName, subscriptionId, parameters);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="parameters"/> is null. </exception>
        public Response Validate(string resourceGroupName, string deploymentName, string subscriptionId, Deployment parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateWhatIfRequest(string resourceGroupName, string deploymentName, string subscriptionId, DeploymentWhatIfProperties properties, string location)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="location"> The location to store the deployment data. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="properties"/> is null. </exception>
        public async Task<Response> WhatIfAsync(string resourceGroupName, string deploymentName, string subscriptionId, DeploymentWhatIfProperties properties, string location = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateWhatIfRequest(resourceGroupName, deploymentName, subscriptionId, properties, location);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, <paramref name="subscriptionId"/>, or <paramref name="properties"/> is null. </exception>
        public Response WhatIf(string resourceGroupName, string deploymentName, string subscriptionId, DeploymentWhatIfProperties properties, string location = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateExportTemplateRequest(string resourceGroupName, string deploymentName, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public async Task<Response<DeploymentExportResult>> ExportTemplateAsync(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateExportTemplateRequest(resourceGroupName, deploymentName, subscriptionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="deploymentName"/>, or <paramref name="subscriptionId"/> is null. </exception>
        public Response<DeploymentExportResult> ExportTemplate(string resourceGroupName, string deploymentName, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Azure.Core.HttpMessage CreateListByResourceGroupRequest(string resourceGroupName, string subscriptionId, string filter, int? top)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<DeploymentListResult>> ListByResourceGroupAsync(string resourceGroupName, string subscriptionId, string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateListByResourceGroupRequest(resourceGroupName, subscriptionId, filter, top);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="subscriptionId"/> is null. </exception>
        public Response<DeploymentListResult> ListByResourceGroup(string resourceGroupName, string subscriptionId, string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
