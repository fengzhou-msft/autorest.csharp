...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ResourceGroupsUpdateOperation : Operation<ResourceGroup>
    {
        private readonly OperationOrResponseInternals<ResourceGroup> _operation;

        /// <summary> Initializes a new instance of ResourceGroupsUpdateOperation for mocking. </summary>
        protected ResourceGroupsUpdateOperation()
        {
        }

        internal ResourceGroupsUpdateOperation(ResourceOperationsBase operationsBase, Response<ResourceGroupData> response)
        {
