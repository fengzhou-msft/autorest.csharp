...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class DeploymentScript : AzureResourceBase
    {
        ...
        internal DeploymentScript(ManagedServiceIdentity identity, string location, IDictionary<string, string> tags, ScriptType kind, SystemData systemData, string id, string name, string type)
        {
            Identity = identity;
            Location = location;
            Tags = tags;
