...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class GenericResourceExpanded : IUtf8JsonSerializable
    {
        ...
        internal static GenericResourceExpanded DeserializeGenericResourceExpanded(JsonElement element)
        {
            ...
            return new GenericResourceExpanded(Optional.ToNullable(createdTime), Optional.ToNullable(changedTime), provisioningState.Value, plan.Value, properties.Value, kind.Value, managedBy.Value, sku.Value, identity.Value, id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags));
        }
    }
}
