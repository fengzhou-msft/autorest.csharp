...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class GenericResourceData : TrackedResource<ResourceGroupResourceIdentifier>
    {
        /// <summary> Initializes a new instance of GenericResourceData. </summary>
        /// <param name="location"> The location. </param>
        public GenericResourceData(LocationData location) : base(location)
        {
        }
        ...
        internal GenericResourceData(ResourceGroupResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, Plan plan, object properties, string kind, string managedBy, Sku sku, Identity identity) : base(id, name, type, location, tags)
        {
            Plan = plan;
