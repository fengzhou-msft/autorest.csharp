...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class AzurePowerShellScript : IUtf8JsonSerializable
    {
        ...
        internal static AzurePowerShellScript DeserializeAzurePowerShellScript(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("containerSettings"))
                        {
                            ...
                            containerSettings = property0.Value.();
                            continue;
                        }
                        if (property0.NameEquals("storageAccountSettings"))
                        {
                            ...
                            storageAccountSettings = property0.Value.();
                            continue;
                        }
                        if (property0.NameEquals("cleanupPreference"))
                        {
                            ...
                            cleanupPreference = property0.Value.();
                            continue;
                        }
            ...
            return new AzurePowerShellScript(containerSettings.Value, storageAccountSettings.Value, Optional.ToNullable(cleanupPreference), Optional.ToNullable(provisioningState), status.Value, Optional.ToDictionary(outputs), primaryScriptUri.Value, Optional.ToList(supportingScriptUris), scriptContent.Value, arguments.Value, Optional.ToList(environmentVariables), forceUpdateTag.Value, retentionInterval, Optional.ToNullable(timeout), azPowerShellVersion, identity, location, Optional.ToDictionary(tags), kind, systemData.Value, id.Value, name.Value, type.Value);
        }
    }
}
