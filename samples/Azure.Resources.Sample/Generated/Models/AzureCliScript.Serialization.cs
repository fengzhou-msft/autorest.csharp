...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class AzureCliScript : IUtf8JsonSerializable
    {
        ...
        internal static AzureCliScript DeserializeAzureCliScript(JsonElement element)
        {
            ...
            return new AzureCliScript(containerSettings.Value, storageAccountSettings.Value, Optional.ToNullable(cleanupPreference), Optional.ToNullable(provisioningState), status.Value, Optional.ToDictionary(outputs), primaryScriptUri.Value, Optional.ToList(supportingScriptUris), scriptContent.Value, arguments.Value, Optional.ToList(environmentVariables), forceUpdateTag.Value, retentionInterval, Optional.ToNullable(timeout), azCliVersion, identity, location, Optional.ToDictionary(tags), kind, systemData.Value, id.Value, name.Value, type.Value);
        }
    }
}
