...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ApplicationDefinition : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationDefinition DeserializeApplicationDefinition(JsonElement element)
        {
            ...
            return new ApplicationDefinition(lockLevel, displayName.Value, isEnabled.Value, authorizations, Optional.ToList(artifacts), description.Value, packageFileUri.Value, mainTemplate.Value, createUiDefinition.Value, managedBy.Value, sku.Value, identity.Value, id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags));
        }
    }
}
