...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class AzureCliScript : DeploymentScript
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="azCliVersion"/>, <paramref name="identity"/>, or <paramref name="location"/> is null. </exception>
        public AzureCliScript(TimeSpan retentionInterval, string azCliVersion, ManagedServiceIdentity identity, string location)
        {
