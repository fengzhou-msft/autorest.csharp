...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ApplicationContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, Application, ApplicationData>
    {
        ...
        /// <summary> The operation to create or update a Application by ID. Please note some properties can be set only during creation. </summary>
        ...
        /// <param name="parameters"> Parameters supplied to the create or update a managed application. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public Response<Application> CreateById(ResourceIdentifier applicationId, ApplicationData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationContainer.CreateById");
            scope.Start();
            try
            {
                ...
                return StartCreateById(applicationId, parameters, cancellationToken: cancellationToken).WaitForCompletion(cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> Parameters supplied to the create or update a managed application. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<Application>> CreateByIdAsync(ResourceIdentifier applicationId, ApplicationData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationContainer.CreateById");
            scope.Start();
            try
            {
                ...
                var operation = await StartCreateByIdAsync(applicationId, parameters, cancellationToken: cancellationToken).ConfigureAwait(false);
                return await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <param name="parameters"> Parameters supplied to the create or update a managed application. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public ApplicationsCreateOrUpdateByIdOperation StartCreateById(ResourceIdentifier applicationId, ApplicationData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationContainer.StartCreateById");
            scope.Start();
            try
            {
                if (applicationId == null)
                ...
                var originalResponse = _restClient.CreateOrUpdateById(applicationId, parameters, cancellationToken: cancellationToken);
                return new ApplicationsCreateOrUpdateByIdOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateByIdRequest(applicationId, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> Parameters supplied to the create or update a managed application. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<ApplicationsCreateOrUpdateByIdOperation> StartCreateByIdAsync(ResourceIdentifier applicationId, ApplicationData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationContainer.StartCreateById");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _restClient.CreateOrUpdateByIdAsync(applicationId, parameters, cancellationToken: cancellationToken).ConfigureAwait(false);
                return new ApplicationsCreateOrUpdateByIdOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateByIdRequest(applicationId, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
        ...
        /// <param name="applicationId"> The fully qualified ID of the managed application, including the managed application name and the managed application resource type. Use the format, /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applications/{application-name}. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public Response<Application> GetById(ResourceIdentifier applicationId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationContainer.GetById");
            scope.Start();
            try
            {
                if (applicationId == null)
                ...
                var response = _restClient.GetById(applicationId, cancellationToken: cancellationToken);
                return Response.FromValue(new Application(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="applicationId"> The fully qualified ID of the managed application, including the managed application name and the managed application resource type. Use the format, /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applications/{application-name}. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<Application>> GetByIdAsync(ResourceIdentifier applicationId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationContainer.GetById");
            scope.Start();
            try
            {
                ...
                var response = await _restClient.GetByIdAsync(applicationId, cancellationToken: cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new Application(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public Pageable<Application> List(CancellationToken cancellationToken = default)
        {
            ...
            Page<Application> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _restClient.ListByResourceGroupNextPage(nextLink, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new Application(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public AsyncPageable<Application> ListAsync(CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<Application>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _restClient.ListByResourceGroupNextPageAsync(nextLink, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new Application(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
