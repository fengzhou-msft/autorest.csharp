...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ApplicationDefinitionOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, ApplicationDefinition>
    {
        ...
        protected internal ApplicationDefinitionOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
            ...
            _pipeline = Pipeline;
            RestClient = new ApplicationDefinitionsRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        public async Task<Azure.Operation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new ApplicationDefinitionsDeleteOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<Azure.Operation> StartDeleteByIdAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new ApplicationDefinitionsDeleteByIdOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteByIdRequest(Id.ResourceGroupName).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
