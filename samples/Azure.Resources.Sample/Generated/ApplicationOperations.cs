...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ApplicationOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, Application>
    {
        ...
        protected internal ApplicationOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
            ...
            _pipeline = Pipeline;
            RestClient = new ApplicationsRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        public async Task<Azure.Operation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new ApplicationsDeleteOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ApplicationData>> UpdateAsync(ApplicationData parameters = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="parameters"> Parameters supplied to update an existing managed application. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ApplicationData> Update(ApplicationData parameters = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationOperations.Update");
            scope.Start();
            try
        ...
        public async Task<Azure.Operation> StartDeleteByIdAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new ApplicationsDeleteByIdOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteByIdRequest(Id.ResourceGroupName).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
