...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class PolicyDefinitionSubscriptionsContainer : ResourceContainerBase<SubscriptionResourceIdentifier, PolicyDefinition, PolicyDefinitionData>
    {
        ...
        private PolicyDefinitionsRestOperations _restClient => new PolicyDefinitionsRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId);
        ...
        public Response<PolicyDefinition> CreateOrUpdate(string policyDefinitionName, PolicyDefinitionData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return StartCreateOrUpdate(policyDefinitionName, parameters, cancellationToken: cancellationToken).WaitForCompletion();
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Filters the list of <see cref="PolicyDefinition" /> for this resource group. </summary>
        ...
        public Pageable<PolicyDefinition> List(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Filters the list of <see cref="PolicyDefinition" /> for this resource group. Makes an additional network call to retrieve the full data model for each resource group. </summary>
        /// <param name="nameFilter"> The filter used in this operation. </param>
        /// <param name="top"> The number of results to return. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        /// <returns> A collection of <see cref="PolicyDefinition" /> that may take multiple service requests to iterate over. </returns>
        public Pageable<PolicyDefinition> List(string nameFilter, int? top = null, CancellationToken cancellationToken = default)
        {
            var results = ListAsGenericResource(null, top, cancellationToken);
            return new PhWrappingPageable<GenericResource, PolicyDefinition>(results, genericResource => new PolicyDefinitionSubscriptionsOperations(genericResource, genericResource.Id as SubscriptionResourceIdentifier).Get().Value);
        }
        ...
        public AsyncPageable<PolicyDefinition> ListAsync(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        /// <returns> An async collection of <see cref="PolicyDefinition" /> that may take multiple service requests to iterate over. </returns>
        public AsyncPageable<PolicyDefinition> ListAsync(string nameFilter, int? top = null, CancellationToken cancellationToken = default)
        {
            var results = ListAsGenericResourceAsync(null, top, cancellationToken);
            return new PhWrappingAsyncPageable<GenericResource, PolicyDefinition>(results, genericResource => new PolicyDefinitionSubscriptionsOperations(genericResource, genericResource.Id as SubscriptionResourceIdentifier).Get().Value);
        }
