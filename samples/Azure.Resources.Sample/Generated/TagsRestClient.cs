...
namespace Azure.ResourceManager.Resources
{
    internal partial class TagsRestClient
    {
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateAtScopeRequest(string scope, Tags properties)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
            ...
            var model = new TagsResource(properties);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="scope"/> or <paramref name="properties"/> is null. </exception>
        public async Task<Response<TagsResource>> CreateOrUpdateAtScopeAsync(string scope, Tags properties, CancellationToken cancellationToken = default)
        {
            if (scope == null)
            {
            ...
            using var message = CreateCreateOrUpdateAtScopeRequest(scope, properties);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="scope"/> or <paramref name="properties"/> is null. </exception>
        public Response<TagsResource> CreateOrUpdateAtScope(string scope, Tags properties, CancellationToken cancellationToken = default)
        {
            if (scope == null)
            {
                throw new ArgumentNullException(nameof(scope));
        ...
        internal Azure.Core.HttpMessage CreateUpdateAtScopeRequest(string scope, TagsPatchResourceOperation? operation, Tags properties)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            request.Headers.Add("Accept", "application/json");
            request.Headers.Add("Content-Type", "application/json");
            var model = new TagsPatchResource()
            {
                Operation = operation,
        ...
        public async Task<Response<TagsResource>> UpdateAtScopeAsync(string scope, TagsPatchResourceOperation? operation = null, Tags properties = null, CancellationToken cancellationToken = default)
        {
            if (scope == null)
            {
                throw new ArgumentNullException(nameof(scope));
            ...
            using var message = CreateUpdateAtScopeRequest(scope, operation, properties);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="scope"/> is null. </exception>
        public Response<TagsResource> UpdateAtScope(string scope, TagsPatchResourceOperation? operation = null, Tags properties = null, CancellationToken cancellationToken = default)
        {
            if (scope == null)
            {
                throw new ArgumentNullException(nameof(scope));
