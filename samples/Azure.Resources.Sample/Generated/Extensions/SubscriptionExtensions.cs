...
namespace Azure.ResourceManager.Resources
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        /// <summary> Gets an object representing a ResourceGroupContainer along with the instance operations that can be performed on it. </summary>
        /// <param name="subscription"> The <see cref="SubscriptionOperations" /> instance the method will execute against. </param>
        public static ResourceGroupContainer GetResourceGroupContainer(this SubscriptionOperations subscription)
        {
            return new ResourceGroupContainer(subscription);
        }
        #endregion
        ...
        private static DeploymentScriptsRestOperations GetDeploymentScriptsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, string subscriptionId, Uri endpoint = null)
        {
            var httpPipeline = ManagementPipelineBuilder.Build(credential, endpoint, clientOptions);
            return new DeploymentScriptsRestOperations(clientDiagnostics, httpPipeline, subscriptionId, endpoint);
        }
        ...
        public static AsyncPageable<DeploymentScript> ListDeploymentScriptAsync(this SubscriptionOperations subscription, CancellationToken cancellationToken = default)
        {
            return subscription.ListResources((baseUri, credential, options) =>
            {
                ...
                var restOperations = GetDeploymentScriptsRestOperations(clientDiagnostics, credential, options, subscription.Id.SubscriptionId, baseUri);
        ...
        /// <summary> Gets an object representing a FeatureResultContainer along with the instance operations that can be performed on it. </summary>
        /// <param name="subscription"> The <see cref="SubscriptionOperations" /> instance the method will execute against. </param>
        public static FeatureResultContainer GetFeatureResultContainer(this SubscriptionOperations subscription)
        {
            return new FeatureResultContainer(subscription);
        }
        #endregion

        #region Application
        private static ApplicationsRestOperations GetApplicationsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, string subscriptionId, Uri endpoint = null)
        {
            var httpPipeline = ManagementPipelineBuilder.Build(credential, endpoint, clientOptions);
            return new ApplicationsRestOperations(clientDiagnostics, httpPipeline, subscriptionId, endpoint);
        }
        ...
        public static AsyncPageable<Application> ListApplicationAsync(this SubscriptionOperations subscription, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetApplicationsRestOperations(clientDiagnostics, credential, options, subscription.Id.SubscriptionId, baseUri);
                var result = ListBySubscriptionAsync(clientDiagnostics, restOperations);
