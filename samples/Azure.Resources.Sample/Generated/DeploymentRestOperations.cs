...
namespace Azure.ResourceManager.Resources
{
    internal partial class DeploymentRestOperations
    {
        ...
        internal Azure.Core.HttpMessage CreateGetAtSubscriptionScopeRequest(string deploymentName, string operationId, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateListAtSubscriptionScopeRequest(string deploymentName, string subscriptionId, int? top)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateGetRequest(string resourceGroupName, string deploymentName, string operationId, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateListRequest(string resourceGroupName, string deploymentName, string subscriptionId, int? top)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
