...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ManagementLockObjectOperations : OperationsBase
    {
        ...
        protected internal ManagementLockObjectOperations(OperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        ...
        public virtual async Task<Response> DeleteAtResourceLevelAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.DeleteAtResourceLevelAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent, Id.Parent.Parent.Parent, Id.Parent.Parent, Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response DeleteAtResourceLevel(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.DeleteAtResourceLevel(Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent, Id.Parent.Parent.Parent, Id.Parent.Parent, Id.Parent, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<ManagementLockObjectData>> GetAtResourceLevelAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.GetAtResourceLevelAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent, Id.Parent.Parent.Parent, Id.Parent.Parent, Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ManagementLockObjectData> GetAtResourceLevel(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.GetAtResourceLevel(Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent, Id.Parent.Parent.Parent, Id.Parent.Parent, Id.Parent, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
