...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ApplicationDefinitionContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ApplicationDefinition, ApplicationDefinitionData>
    {
        ...
        private ApplicationDefinitionsRestOperations _restClient => new ApplicationDefinitionsRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId);
        ...
        public Response<ApplicationDefinition> CreateOrUpdate(string applicationDefinitionName, ApplicationDefinitionData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return StartCreateOrUpdate(applicationDefinitionName, parameters, cancellationToken: cancellationToken).WaitForCompletion();
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public ApplicationDefinitionsCreateOrUpdateOperation StartCreateOrUpdate(string applicationDefinitionName, ApplicationDefinitionData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new ApplicationDefinitionsCreateOrUpdateOperation(Parent, _clientDiagnostics, _pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, applicationDefinitionName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Filters the list of <see cref="ApplicationDefinition" /> for this resource group. </summary>
        ...
        public Pageable<ApplicationDefinition> List(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Filters the list of <see cref="ApplicationDefinition" /> for this resource group. Makes an additional network call to retrieve the full data model for each resource group. </summary>
        /// <param name="nameFilter"> The filter used in this operation. </param>
        /// <param name="top"> The number of results to return. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        /// <returns> A collection of <see cref="ApplicationDefinition" /> that may take multiple service requests to iterate over. </returns>
        public Pageable<ApplicationDefinition> List(string nameFilter, int? top = null, CancellationToken cancellationToken = default)
        {
            var results = ListAsGenericResource(null, top, cancellationToken);
            return new PhWrappingPageable<GenericResource, ApplicationDefinition>(results, genericResource => new ApplicationDefinitionOperations(genericResource, genericResource.Id as ResourceGroupResourceIdentifier).Get().Value);
        }
        ...
        public AsyncPageable<ApplicationDefinition> ListAsync(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        /// <returns> An async collection of <see cref="ApplicationDefinition" /> that may take multiple service requests to iterate over. </returns>
        public AsyncPageable<ApplicationDefinition> ListAsync(string nameFilter, int? top = null, CancellationToken cancellationToken = default)
        {
            var results = ListAsGenericResourceAsync(null, top, cancellationToken);
            return new PhWrappingAsyncPageable<GenericResource, ApplicationDefinition>(results, genericResource => new ApplicationDefinitionOperations(genericResource, genericResource.Id as ResourceGroupResourceIdentifier).Get().Value);
        }
