...
namespace Azure.ResourceManager.Resources
{
    internal partial class ResourceGroupsRestClient
    {
        ...
        public ResourceGroupsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
        ...
        internal Azure.Core.HttpMessage CreateExportTemplateRequest(string resourceGroupName, IEnumerable<string> resources, string options)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> is null. </exception>
        public async Task<Response> ExportTemplateAsync(string resourceGroupName, IEnumerable<string> resources = null, string options = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> is null. </exception>
        public Response ExportTemplate(string resourceGroupName, IEnumerable<string> resources = null, string options = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
