...
namespace Azure.ResourceManager.Resources
{
    internal partial class ApplicationDefinitionsRestOperations
    {
        ...
        internal Azure.Core.HttpMessage CreateGetByIdRequest(string applicationDefinitionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<ApplicationDefinitionData>> GetByIdAsync(string applicationDefinitionId, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="applicationDefinitionId"/> is null. </exception>
        public Response<ApplicationDefinitionData> GetById(string applicationDefinitionId, CancellationToken cancellationToken = default)
        {
            if (applicationDefinitionId == null)
            {
                throw new ArgumentNullException(nameof(applicationDefinitionId));
        ...
        internal Azure.Core.HttpMessage CreateDeleteByIdRequest(string applicationDefinitionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateByIdRequest(string applicationDefinitionId, ApplicationDefinitionData parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<Response> CreateOrUpdateByIdAsync(string applicationDefinitionId, ApplicationDefinitionData parameters, CancellationToken cancellationToken = default)
        {
            if (applicationDefinitionId == null)
            {
                throw new ArgumentNullException(nameof(applicationDefinitionId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="applicationDefinitionId"/> or <paramref name="parameters"/> is null. </exception>
        public Response CreateOrUpdateById(string applicationDefinitionId, ApplicationDefinitionData parameters, CancellationToken cancellationToken = default)
        {
            if (applicationDefinitionId == null)
            {
                throw new ArgumentNullException(nameof(applicationDefinitionId));
