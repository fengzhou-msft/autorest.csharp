...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class DeploymentExtendedOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, DeploymentExtended>
    {
        ...
        protected internal DeploymentExtendedOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
            ...
            _pipeline = Pipeline;
            RestClient = new DeploymentsRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        public async Task<Azure.Operation> StartDeleteAtScopeAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsDeleteAtScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteAtScopeRequest(Id.Name, Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<DeploymentsValidateAtScopeOperation> StartValidateAtScopeAsync(Deployment parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsValidateAtScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateValidateAtScopeRequest(Id.Name, Id.Name, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<Azure.Operation> StartDeleteAtTenantScopeAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsDeleteAtTenantScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteAtTenantScopeRequest(Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<DeploymentsValidateAtTenantScopeOperation> StartValidateAtTenantScopeAsync(ScopedDeployment parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsValidateAtTenantScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateValidateAtTenantScopeRequest(Id.Name, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<Azure.Operation> StartDeleteAtManagementGroupScopeAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsDeleteAtManagementGroupScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteAtManagementGroupScopeRequest(Id.Name, Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<DeploymentsValidateAtManagementGroupScopeOperation> StartValidateAtManagementGroupScopeAsync(ScopedDeployment parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsValidateAtManagementGroupScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateValidateAtManagementGroupScopeRequest(Id.Name, Id.Name, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<Azure.Operation> StartDeleteAtSubscriptionScopeAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsDeleteAtSubscriptionScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteAtSubscriptionScopeRequest(Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<DeploymentsValidateAtSubscriptionScopeOperation> StartValidateAtSubscriptionScopeAsync(Deployment parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsValidateAtSubscriptionScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateValidateAtSubscriptionScopeRequest(Id.Name, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<DeploymentsWhatIfAtSubscriptionScopeOperation> StartWhatIfAtSubscriptionScopeAsync(DeploymentWhatIfProperties properties, string location = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsWhatIfAtSubscriptionScopeOperation(_clientDiagnostics, _pipeline, RestClient.CreateWhatIfAtSubscriptionScopeRequest(Id.Name, properties, location).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<Azure.Operation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsDeleteOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteRequest(Id.Name, Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<DeploymentsValidateOperation> StartValidateAsync(Deployment parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsValidateOperation(_clientDiagnostics, _pipeline, RestClient.CreateValidateRequest(Id.Name, Id.Name, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<DeploymentsWhatIfOperation> StartWhatIfAsync(DeploymentWhatIfProperties properties, string location = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new DeploymentsWhatIfOperation(_clientDiagnostics, _pipeline, RestClient.CreateWhatIfRequest(Id.Name, Id.Name, properties, location).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
