...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ManagementLockObjectResourceGroupsContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ManagementLockObject, ManagementLockObjectData>
    {
        ...
        private ManagementLocksRestOperations _restClient => new ManagementLocksRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId);
        ...
        public Response<ManagementLockObject> CreateOrUpdate(string lockName, ManagementLockObjectData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return StartCreateOrUpdate(lockName, parameters, cancellationToken: cancellationToken).WaitForCompletion();
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Filters the list of <see cref="ManagementLockObject" /> for this resource group. </summary>
        ...
        public Pageable<ManagementLockObject> List(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Filters the list of <see cref="ManagementLockObject" /> for this resource group. Makes an additional network call to retrieve the full data model for each resource group. </summary>
        /// <param name="nameFilter"> The filter used in this operation. </param>
        /// <param name="top"> The number of results to return. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        /// <returns> A collection of <see cref="ManagementLockObject" /> that may take multiple service requests to iterate over. </returns>
        public Pageable<ManagementLockObject> List(string nameFilter, int? top = null, CancellationToken cancellationToken = default)
        {
            var results = ListAsGenericResource(null, top, cancellationToken);
            return new PhWrappingPageable<GenericResource, ManagementLockObject>(results, genericResource => new ManagementLockObjectResourceGroupsOperations(genericResource, genericResource.Id as ResourceGroupResourceIdentifier).Get().Value);
        }
        ...
        public AsyncPageable<ManagementLockObject> ListAsync(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        /// <returns> An async collection of <see cref="ManagementLockObject" /> that may take multiple service requests to iterate over. </returns>
        public AsyncPageable<ManagementLockObject> ListAsync(string nameFilter, int? top = null, CancellationToken cancellationToken = default)
        {
            var results = ListAsGenericResourceAsync(null, top, cancellationToken);
            return new PhWrappingAsyncPageable<GenericResource, ManagementLockObject>(results, genericResource => new ManagementLockObjectResourceGroupsOperations(genericResource, genericResource.Id as ResourceGroupResourceIdentifier).Get().Value);
        }
